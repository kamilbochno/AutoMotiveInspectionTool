...
const EditVehicle = () => {
	const {onAddOrEdit,formData,handleSelectChange,handleInputChange, handleSubmit, editVehicle, vehicles, setVehicles, list } = useVehiclesContext();
	console.log(formData) 
	return (      
    <div className="main-vehicle">
			<div className="main-form">
				<Form onSubmit={editVehicle} autoComplete="off">
